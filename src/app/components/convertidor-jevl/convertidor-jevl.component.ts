...
@Component({
  selector: 'jevl-convertidor-jevl',
  templateUrl: './convertidor-jevl.component.html',
  styleUrls: ['./convertidor-jevl.component.css'],
})
export class ConvertidorJEVLComponent implements OnInit {
  cantidad = 0;
  tengo = 'USD';
  quiero = 'EUR';
  total = 0;
  ...
  convertir(): void {
    switch (this.tengo) {
      ...
      case 'LIBRA':
        ...
        if (this.quiero === 'JPY') {
          this.total = this.cantidad * 189.0;
        }
        if (this.quiero === 'SGD') {
      ...
      case 'JPY':
        ...
        if (this.quiero === 'SGD') {
          this.total = this.cantidad * 0.009;
        }
        if (this.quiero === 'CNY') {
          this.total = this.cantidad * 0.049;
        }
        if (this.quiero === 'AUD') {
          this.total = this.cantidad * 0.01;
        }
        if (this.quiero === 'CAD') {
